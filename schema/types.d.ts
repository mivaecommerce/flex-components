...
export interface FlexComponentTypeComponent extends BaseFlexComponent {
	...
	category?: 'category-carousel' | 'combination-facet' | 'featured-product' | 'image-across' | 'image-slider' | 'image-text' | 'image' | 'non-element' | 'product-carousel' | 'product-display' | 'product-list' | 'quick-order' | 'text-area' | 'text-banner' | 'text-editor' | 'text-utility' | 'video';
